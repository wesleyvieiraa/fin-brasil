...
@Component({
  ...
  templateUrl: './secondary-horizontal-casual.component.html',
  styleUrls: ['./secondary-horizontal-casual.component.scss']
})
export class SecondaryHorizontalCasualComponent implements OnInit {
